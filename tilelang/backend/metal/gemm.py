...
from tilelang.tileop.gemm.gemm_metal import GEMM_INST_METAL_SIMDGROUP, GemmMetal
...
register_gemm_impl("metal.simdgroup", GEMM_INST_METAL_SIMDGROUP, _match_metal, GemmMetal)
