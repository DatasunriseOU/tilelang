...
_EVAL_TYPE_ACCEPTS_TYPE_PARAMS = "type_params" in inspect.signature(_eval_type).parameters


def _eval_forward_ref(value, *, globalns, localns):
    if _EVAL_TYPE_ACCEPTS_TYPE_PARAMS:
...
def get_type_hints(func):
    ...
    for name, value in annot.items():
        ...
        if isinstance(value, str):
            ...
            hints[name] = _eval_forward_ref(value, globalns=globalns, localns=localns)
        else:
            hints[name] = value
    return hints
