...
inline ProofHookStatus
GetProofHookStatus(const tvm::transform::PassContext &ctx, ProofHookKind kind,
  ...
  const char *env_pass_name = env_pass_name_override
                                  ? env_pass_name_override
                                  : ProofHookEnvPassName(kind);
